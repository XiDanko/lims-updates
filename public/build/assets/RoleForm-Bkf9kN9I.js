...
`,""])},function(g,N){g.exports=function(i){var r=[];return r.toString=function(){return this.map(function(o){var l=function(u,w){var d=u[1]||"",e=u[3];if(!e)return d;if(w&&typeof btoa=="function"){var t=(s=e,"/*# sourceMappingURL=data:application/json;charset=utf-8;base64,"+btoa(unescape(encodeURIComponent(JSON.stringify(s))))+" */"),n=e.sources.map(function(c){return"/*# sourceURL="+e.sourceRoot+c+" */"});return[d].concat(n).concat([t]).join(`
`)}var s;return[d].join(`
`)}(o,i);return o[2]?"@media "+o[2]+"{"+l+"}":l}).join("")},r.i=function(o,l){typeof o=="string"&&(o=[[null,o,""]]);for(var u={},w=0;w<this.length;w++){var d=this[w][0];typeof d=="number"&&(u[d]=!0)}for(w=0;w<o.length;w++){var e=o[w];typeof e[0]=="number"&&u[e[0]]||(l&&!e[2]?e[2]=l:l&&(e[2]="("+e[2]+") and ("+l+")"),r.push(e))}},r}},function(g,N,i){var r,o,l={},u=(r=function(){return window&&document&&document.all&&!window.atob},function(){return typeof o>"u"&&(o=r.apply(this,arguments)),o}),w=function(p){var a={};return function(f){if(typeof f=="function")return f();if(typeof a[f]>"u"){var v=function(_){return document.querySelector(_)}.call(this,f);if(window.HTMLIFrameElement&&v instanceof window.HTMLIFrameElement)try{v=v.contentDocument.head}catch{v=null}a[f]=v}return a[f]}}(),d=null,e=0,t=[],n=i(6);function s(p,a){for(var f=0;f<p.length;f++){var v=p[f],_=l[v.id];if(_){_.refs++;for(var j=0;j<_.parts.length;j++)_.parts[j](v.parts[j]);for(;j<v.parts.length;j++)_.parts.push(x(v.parts[j],a))}else{var I=[];for(j=0;j<v.parts.length;j++)I.push(x(v.parts[j],a));l[v.id]={id:v.id,refs:1,parts:I}}}}function c(p,a){for(var f=[],v={},_=0;_<p.length;_++){var j=p[_],I=a.base?j[0]+a.base:j[0],y={css:j[1],media:j[2],sourceMap:j[3]};v[I]?v[I].parts.push(y):f.push(v[I]={id:I,parts:[y]})}return f}function h(p,a){var f=w(p.insertInto);if(!f)throw new Error("Couldn't find a style target. This probably means that the value for the 'insertInto' parameter is invalid.");var v=t[t.length-1];if(p.insertAt==="top")v?v.nextSibling?f.insertBefore(a,v.nextSibling):f.appendChild(a):f.insertBefore(a,f.firstChild),t.push(a);else if(p.insertAt==="bottom")f.appendChild(a);else{if(typeof p.insertAt!="object"||!p.insertAt.before)throw new Error(`[Style Loader]

 Invalid value for parameter 'insertAt' ('options.insertAt') found.
 Must be 'top', 'bottom', or Object.
 (https://github.com/webpack-contrib/style-loader#insertat)
`);var _=w(p.insertInto+" "+p.insertAt.before);f.insertBefore(a,_)}}function b(p){if(p.parentNode===null)return!1;p.parentNode.removeChild(p);var a=t.indexOf(p);a>=0&&t.splice(a,1)}function k(p){var a=document.createElement("style");return p.attrs.type===void 0&&(p.attrs.type="text/css"),C(a,p.attrs),h(p,a),a}function C(p,a){Object.keys(a).forEach(function(f){p.setAttribute(f,a[f])})}function x(p,a){var f,v,_,j;if(a.transform&&p.css){if(!(j=a.transform(p.css)))return function(){};p.css=j}if(a.singleton){var I=e++;f=d||(d=k(a)),v=P.bind(null,f,I,!1),_=P.bind(null,f,I,!0)}else p.sourceMap&&typeof URL=="function"&&typeof URL.createObjectURL=="function"&&typeof URL.revokeObjectURL=="function"&&typeof Blob=="function"&&typeof btoa=="function"?(f=function(y){var E=document.createElement("link");return y.attrs.type===void 0&&(y.attrs.type="text/css"),y.attrs.rel="stylesheet",C(E,y.attrs),h(y,E),E}(a),v=function(y,E,R){var U=R.css,F=R.sourceMap,ne=E.convertToAbsoluteUrls===void 0&&F;(E.convertToAbsoluteUrls||ne)&&(U=n(U)),F&&(U+=`
/*# sourceMappingURL=data:application/json;base64,`+btoa(unescape(encodeURIComponent(JSON.stringify(F))))+" */");var se=new Blob([U],{type:"text/css"}),H=y.href;y.href=URL.createObjectURL(se),H&&URL.revokeObjectURL(H)}.bind(null,f,a),_=function(){b(f),f.href&&URL.revokeObjectURL(f.href)}):(f=k(a),v=function(y,E){var R=E.css,U=E.media;if(U&&y.setAttribute("media",U),y.styleSheet)y.styleSheet.cssText=R;else{for(;y.firstChild;)y.removeChild(y.firstChild);y.appendChild(document.createTextNode(R))}}.bind(null,f),_=function(){b(f)});return v(p),function(y){if(y){if(y.css===p.css&&y.media===p.media&&y.sourceMap===p.sourceMap)return;v(p=y)}else _()}}g.exports=function(p,a){if(typeof DEBUG<"u"&&DEBUG&&typeof document!="object")throw new Error("The style-loader cannot be used in a non-browser environment");(a=a||{}).attrs=typeof a.attrs=="object"?a.attrs:{},a.singleton||typeof a.singleton=="boolean"||(a.singleton=u()),a.insertInto||(a.insertInto="head"),a.insertAt||(a.insertAt="bottom");var f=c(p,a);return s(f,a),function(v){for(var _=[],j=0;j<f.length;j++){var I=f[j];(y=l[I.id]).refs--,_.push(y)}for(v&&s(c(v,a),a),j=0;j<_.length;j++){var y;if((y=_[j]).refs===0){for(var E=0;E<y.parts.length;E++)y.parts[E]();delete l[y.id]}}}};var m,A=(m=[],function(p,a){return m[p]=a,m.filter(Boolean).join(`
`)});function P(p,a,f,v){var _=f?"":v.css;if(p.styleSheet)p.styleSheet.cssText=A(a,_);else{var j=document.createTextNode(_),I=p.childNodes;I[a]&&p.removeChild(I[a]),I.length?p.insertBefore(j,I[a]):p.appendChild(j)}}},function(g,N){g.exports=function(i){var r=typeof window<"u"&&window.location;if(!r)throw new Error("fixUrls requires window.location");if(!i||typeof i!="string")return i;var o=r.protocol+"//"+r.host,l=o+r.pathname.replace(/\/[^\/]*$/,"/");return i.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi,function(u,w){var d,e=w.trim().replace(/^"(.*)"$/,function(t,n){return n}).replace(/^'(.*)'$/,function(t,n){return n});return/^(#|data:|http:\/\/|https:\/\/|file:\/\/\/|\s*$)/i.test(e)?u:(d=e.indexOf("//")===0?e:e.indexOf("/")===0?o+e:l+e.replace(/^\.\//,""),"url("+JSON.stringify(d)+")")})}}]).default})})(te);var ve=te.exports;ee.exports=ve;var me=ee.exports;const ye=re(me),je={class:"mb-1 flex items-center gap-1 pt-2 ps-2"},ge=Y({__name:"Treeselect",props:{modelValue:{},options:{}},emits:["update:modelValue"],setup(T,{emit:O}){const g=T,N=O;let i=null;Z(()=>{r()});const r=()=>{i=new ye("#treeselect",{data:g.options,values:g.modelValue,closeDepth:1,onChange:function(){N("update:modelValue",this.values)}})},o=()=>{i.values=g.options.map(l=>l.id)};return oe(()=>g.modelValue,l=>{l===void 0&&(i.values=[])}),(l,u)=>(D(),z("div",null,[B("div",je,[B("span",{class:"p-1 text-xs btn-blue",onClick:o},"Check All"),B("span",{class:"p-1 text-xs btn-gray",onClick:u[0]||(u[0]=w=>G(i).values=[])},"Clear")]),u[1]||(u[1]=B("div",{id:"treeselect",class:"overflow-y-auto max-h-[13rem]"},null,-1))]))}}),we=()=>{const T=S([]),O=S([]),g=async()=>{const{data:r}=await V.get("/api/permissions/list");O.value=r},N=async()=>{await g();let r=O.value.map(o=>o.split(".")[0]);return r=[...new Set(r)],r.forEach(o=>{T.value.push(i(o))}),T.value},i=r=>{const o={id:r,text:J.startCase(r),children:[]};return O.value.filter(u=>u.startsWith(r+".")).forEach(u=>o.children.push({id:u,text:J.startCase(u.split(".")[1])})),o};return{getPermissionsTree:N}},xe={key:0,class:"relative"},_e={class:"relative"},ke={key:0,class:"text-sm text-red-500"},Ne={class:"relative"},Ce={key:1,class:"text-sm text-red-500"},Ie=["disabled"],Te=Y({__name:"RoleForm",emits:["close"],setup(T,{emit:O}){const g=pe(),N=fe(),i=S({}),{getPermissionsTree:r}=we(),o=S(L.Create),l=S(!1),u=S({}),w=S(null),d=ae().user.branches,e=O;Z(async()=>{d.length===1&&(i.value.branchId=d[0].id),g.path.endsWith("/edit")&&(o.value=L.Edit),g.path.endsWith("/clone")&&(o.value=L.Clone),o.value!==L.Create&&await t(g.params.id),w.value=await r()});const t=async C=>{const{data:x}=await V.get(`/api/roles/${C}`);i.value=x.data},n=async()=>{l.value=!0;try{o.value===L.Create?await s():o.value===L.Clone?await c():o.value===L.Edit&&await h(),u.value={},he.fire()}catch(C){u.value=C.response.data.errors??{}}l.value=!1},s=async()=>{await V.post("/api/roles",i.value),b()},c=async()=>{await V.post("/api/roles",i.value),k()},h=async()=>{await V.patch(`/api/roles/${i.value.id}`,i.value),k()},b=()=>{i.value={},u.value=[]},k=()=>{e("close"),N.back()};return(C,x)=>(D(),Q(ue,null,{header:M(()=>[X(W(`${o.value.capitalize()} ${o.value===G(L).Create?"New":""} Role`),1)]),body:M(()=>[B("form",{id:"form",onSubmit:de(n,["prevent","stop"]),class:"grid grid-cols-1 gap-4"},[G(d).length>1?(D(),z("div",xe,[K(be,{modelValue:i.value.branchId,"onUpdate:modelValue":x[0]||(x[0]=m=>i.value.branchId=m),error:u.value.branchId},null,8,["modelValue","error"])])):$("",!0),B("div",_e,[ie(B("input",{"onUpdate:modelValue":x[1]||(x[1]=m=>i.value.displayName=m),class:q(["input peer",{"border-red-500":u.value.hasOwnProperty("displayName")}])},null,2),[[le,i.value.displayName]]),B("label",{class:q(["label",{"text-red-500":u.value.hasOwnProperty("displayName")}])},"Name",2),u.value.hasOwnProperty("displayName")?(D(),z("p",ke,W(u.value.displayName[0]),1)):$("",!0)]),B("div",Ne,[w.value?(D(),Q(ge,{key:0,options:w.value,modelValue:i.value.permissions,"onUpdate:modelValue":x[2]||(x[2]=m=>i.value.permissions=m),class:q(["rounded border-2 border-gray-300 pt-1",{"border-red-500":u.value.hasOwnProperty("permissions")}])},null,8,["options","modelValue","class"])):$("",!0),B("label",{class:q(["label",{"text-red-500":u.value.hasOwnProperty("permissions")}])},"Permissions",2),u.value.hasOwnProperty("permissions")?(D(),z("p",Ce,W(u.value.permissions[0]),1)):$("",!0)])],32)]),footer:M(()=>[B("button",{class:"me-2 btn-blue",disabled:l.value,form:"form"},[K(ce,{"is-loading":l.value},{default:M(()=>x[3]||(x[3]=[X("Save")])),_:1},8,["is-loading"])],8,Ie),B("button",{onClick:k,class:"btn-gray"},"Cancel")]),_:1}))}});export{Te as default};
